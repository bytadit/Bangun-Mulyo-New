<div class="modal fade" id="editDataPinjaman{{ $pinjaman->id }}" tabindex="-1" aria-labelledby="modalEditPinjaman{{ $pinjaman->id }}">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data" action="{{route('pinjaman-kelompok.update', ['kelompok' => $kelompok, 'pinjaman_kelompok' => $pinjaman->id])}}">
                    @csrf
                    @method('put')
                    <div class="row g-3">
