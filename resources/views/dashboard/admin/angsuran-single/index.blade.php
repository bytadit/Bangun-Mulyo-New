...
@section('title') @lang('Data Riwayat Angsuran Perorangan {{ $single_name }} - BUMDes Bangun Mulyo') @endsection
@section('css')
...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('li_3')
            Data Pinjaman {{ $single_name }}
        @endslot
        @slot('li_2_link')
            {{ route('angsuran-single.daftar-peminjam') }}
        @endslot
        @slot('li_3_link')
            {{ route('angsuran-single.daftar-pinjaman', ['single' => $single]) }}
        @endslot
        @slot('title')
            {{ $title }}
        @endslot
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h3 class="card-title mb-0 flex-grow-1">Progress Pinjaman {{ $single_name }} Periode ke - {{ $periode }}</h3>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-medium">
                                                    <form action="{{ route('cetak.kuitansi-angsuran-single') }}" method="POST">
                                                        @csrf
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-medium">
                                                    <button class="btn btn-sm btn-warning mx-1"  data-bs-toggle="modal" data-bs-target="#editDataAngsuranSingle{{$angsuran->id}}">
                                                        <i class="ri-pencil-line"></i> <span >@lang('Ubah')</span>
                                                    </button>
                                                    <button class="btn btn-sm btn-danger ml-1" data-bs-toggle="modal" data-bs-target="#deleteDataAngsuranSingle{{$angsuran->id}}">
                                                        <i class="ri-delete-bin-line"></i> <span >@lang('Hapus')</span>
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
                                        @include('dashboard.admin.angsuran-single.modals.edit')
                                        @include('dashboard.admin.angsuran-single.modals.delete')
                                    @endforeach
                                    </tbody>
                                </table>
                            </div>
