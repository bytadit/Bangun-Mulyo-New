                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-0">Berikut adalah data pinjaman {{ $single_name }} di BUMDes Bangun Mulyo!</p>
                            </div>
                        </div>
                    </div>
                    <!--end col-->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header text-center">
                                <h1 class="mb-0">Pinjaman {{ $single_name }}</h1>
                            </div>
                            <div class="card-body">
                                <table id="scroll-horizontal" class="table nowrap align-middle table-hover table-bordered" style="width:100%">
                                    ...
                                    @foreach($pinjamans as $pinjaman)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-medium">
                                                    <form action="{{ route('cetak.kuitansi-lunas-single') }}" method="POST">
                                                        @csrf
                                        ...
                                        @include('dashboard.admin.angsuran-single.modals.info-pinjaman')
                                    @endforeach
                                    </tbody>
                                </table>
                            </div>
