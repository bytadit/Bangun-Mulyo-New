    ...
    <div class="row">
        <div class="col">
            <div class="h-100">
                ...
                <!--end row-->
                @include('dashboard.admin.peminjam-single.modals.create')
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-medium">
                                                    ...
                                                    <button class="btn btn-sm btn-danger ml-1" data-bs-toggle="modal" data-bs-target="#deleteDataPeminjamSingle{{$single->id}}">
                                                        <i class="ri-delete-bin-line"></i> <span >@lang('Hapus')</span>
                                                    </button>
                                                </div>
                                            </td>
                                        </tr>
                                        @include('dashboard.admin.peminjam-single.modals.edit')
                                        @include('dashboard.admin.peminjam-single.modals.delete')
                                    @endforeach
                                    </tbody>
                                </table>
                            </div>
